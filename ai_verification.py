...
3. У каждого игрока видна статистика K/D/A (убийства/смерти/ассисты)
4. Может быть отмечен MVP звездой ⭐
...
ВАЖНО ПО ИГРЕ:
1. Стороны меняются после 12 раундов (при счёте 12-X или X-12)
2. Матч играется до 13 побед (максимальный счёт 13:X или в овертайме больше)
3. На скриншоте видны ники игроков и их статистика (K/D/A)
4. MVP может быть указан звездой или отмечен как "MVP"
...
3. Статистику каждого игрока (K/D/A)
4. MVP матча (если указан)
